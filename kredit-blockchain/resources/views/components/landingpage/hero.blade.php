<div class="flex items-center justify-between px-[50px] w-[1320px] h-[610px] rounded-2xl border border-[#c7e7ff] bg-white">
    <div class="w-[600px]">
        ...
        <div class="inline-flex w-full h-full items-center mt-5">
