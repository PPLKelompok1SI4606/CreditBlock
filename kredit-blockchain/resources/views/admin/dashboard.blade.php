                    ...
                    <tr class="hover:bg-gray-50 transition-all duration-200">
                        ...
                        <td class="px-6 py-4">
                            @php
                                ...
                                $status = $statusLabels[$loan->status] ?? 'Tidak Diketahui';
                                $style = $statusStyles[$loan->status] ?? 'bg-gray-100 text-gray-700';
                            @endphp
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                @if($loan->status === 'PENDING')
                                    <form action="{{ route('admin.loan-applications.update-status', $loan->id) }}" method="POST" class="inline">
                                        ...
                                        <button type="submit" class="bg-blue-600 text-white px-3 py-2 rounded-lg text-xs font-medium hover:bg-blue-700 transition-all duration-200"
