                ...
                <div class="bg-white border border-gray-200 rounded-2xl shadow-sm p-6 card-hover transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-3xl font-bold text-green-600">{{ $loanApplications->where('status', 'disetujui')->count() }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white border border-gray-200 rounded-2xl shadow-sm p-6 card-hover transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-3xl font-bold text-green-600">{{ $loanApplications->where('status', 'menunggu')->count() }}</p>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <td class="px-6 py-4 w-64 whitespace-nowrap">
                                        <div class="flex items-center space-x-2">
                                            ...
                                            @if($loan->status == 'menunggu')
                                                <form action="{{ route('admin.loan-applications.approve', $loan->id) }}" method="POST" style="display:inline;">
                                                    @csrf
                                                ...
                                                <form action="{{ route('admin.loan-applications.reject', $loan->id) }}" method="POST" style="display:inline;">
                                                    @csrf
