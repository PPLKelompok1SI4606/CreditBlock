...
<script>
    ...
    <div class="bg-white border border-gray-200 rounded-2xl shadow-sm p-6 transition-all duration-300 card-hover hover:shadow-lg">
        ...
        <ul class="space-y-4">
            ...
            @empty
                <li class="p-4 text-center text-gray-500">Tidak ada verifikasi KYC menunggu.</li>
            @endforelse
        </ul>
    </div>

    <!-- Modal untuk Pengguna -->
    @foreach ($users as $user)
        <div id="user-modal-{{ $user->id }}" class="modal">
            <div class="modal-content">
                <button type="button" class="modal-close" onclick="closeModal('user-modal-{{ $user->id }}')">
            ...
            <div class="modal-content">
                ...
                <div class="mt-6 text-center">
                    <a href="{{ Storage::url($application->document_path) }}" target="_blank"
                       class="inline-flex items-center modal-document-btn text-white bg-blue-500 px-4 py-2 rounded-lg hover:bg-blue-600">
