...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <!-- Table Card -->
        <div class="relative bg-white bg-opacity-20 backdrop-blur-lg border border-blue-100/50 rounded-3xl shadow-xl p-6 sm:p-8 transition-all duration-500 hover:shadow-[0_8px_25px_rgba(42,157,244,0.2)] hover:-translate-y-1 animate-fade-in-up">
            <div class="relative rounded-2xl p-6 bg-gradient-to-br from-blue-50/50 to-blue-100/30 text-blue-600 overflow-hidden">
                <!-- Success Message -->
                @if (session('success'))
                    <div class="mb-6 p-4 bg-blue-100 border-l-4 border-blue-500 text-blue-800 rounded-xl flex items-center animate-pulse">
                ...
                <!-- Error Message -->
                @if (session('error'))
                    <div class="mb-6 p-4 bg-red-100 border-l-4 border-red-500 text-red-800 rounded-xl flex items-center animate-pulse">
                ...
                <div class="relative overflow-x-auto scrollbar-thin scrollbar-thumb-blue-300 scrollbar-track-blue-100">
                    <!-- Scroll Shadows -->
                    <div class="absolute inset-y-0 left-0 w-4 bg-gradient-to-r from-blue-100/50 to-transparent pointer-events-none z-10"></div>
                    <div class="absolute inset-y-0 right-0 w-4 bg-gradient-to-l from-blue-100/50 to-transparent pointer-events-none z-10"></div>
                            ...
                            @forelse ($loanApplications as $loan)
                                <tr class="hover:bg-blue-50/30 transition-all duration-200">
                                    ...
                                    <td class="py-4 px-6 group relative">
                                        ...
                                        @endphp
                                        <span class="{{ $style }} px-3 py-1 rounded-full text-xs font-medium whitespace-nowrap shadow-[0_2px_5px_rgba(42,157,244,0.2)]">
                                            {{ $status }}
                                        </span>
                                        <span class="absolute hidden group-hover:block -top-8 left-1/2 transform -translate-x-1/2 bg-blue-600 text-white text-xs rounded py-1 px-2 animate-slide-up">
                                            {{ $tooltip }}
                                        </span>
                                    </td>
                                </tr>
